...
macro(ADD_VM_DEFINITIONS BASE_DEFINITIONS)
	ADD_BASE_DEFINITIONS(${BASE_DEFINITIONS})
	ADD_LIB_DEFINITIONS(${BASE_DEFINITIONS})
...
macro(ADD_TOOLS_DEFINITIONS TOOLS_DEFINITIONS)
	if(MSVC)
#todo set this for all target
		#Character Set, CharacterSet="0", Not Set, ASCII/SBCS (Single Byte Character Set)
		list(APPEND ${TOOLS_DEFINITIONS} "-D_SBCS")

		#disable deprecation warnings about old functions like strcmp
		list(APPEND ${TOOLS_DEFINITIONS} "-D_CRT_SECURE_NO_WARNINGS")
		list(APPEND ${TOOLS_DEFINITIONS} "-D_CRT_NONSTDC_NO_DEPRECATE")
...
macro(ADD_LIB_DEFINITIONS LIB_DEFINITIONS)
	ADD_TOOLS_DEFINITIONS(${LIB_DEFINITIONS})
